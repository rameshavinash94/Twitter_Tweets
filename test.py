...
# test each routes one by one     
    ...
    def test3(self):
        ...
        with app.app.test_client() as client:
            try:
                ...
                self.assertEqual(res.status_code,200)
                print ('Tweet posted successsfully')
            except Exception as e:
                print("some exception occured {}".format(e))
        ...
        with app.app.test_client() as client:
            try:
                ...
                try:
                    ...
                    print ('Tweet results are found and retreived successsfully')
                except Exception as e:
    ...
    def test5(self):
        tweet_text="test3"
        tweet_id="1441470106614177792" ### add the tweet value to test delete
        with app.app.test_client() as client:
            try:
